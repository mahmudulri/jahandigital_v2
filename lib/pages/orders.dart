...
import 'package:jahandigital/helpers/localtime_helper.dart';
                                    ...
                                    Obx(
                                      () => Text(
                                        selectedDate.isEmpty
                                            ...
                                            : selectedDate
                                                  .value, // Show selected date or placeholder
                                        style: TextStyle(
                                          fontSize: screenWidth * 0.040,
                                        ),
                                      ),
          ...
          child: Column(
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  KText(text: languagesController.tr("SELLING_PRICE")),
                  SizedBox(width: 10),
                  GestureDetector(
                    onTap: () {
                      setState(() {
